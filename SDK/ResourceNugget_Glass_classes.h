...
// BlueprintGeneratedClass ResourceNugget_Glass.ResourceNugget_Glass_C
// 0x0011 (0x06E9 - 0x06D8)
class AResourceNugget_Glass_C : public AResourceBundle_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ResourceNugget_Glass.ResourceNugget_Glass_C");
		return ptr;
	}
	...
	void SetView();
	void ExecuteUbergraph_ResourceNugget_Glass(int EntryPoint);
};
