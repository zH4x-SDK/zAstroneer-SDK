...
struct AWinch_C_GetBodySlotLegacy_Params
{
	class UChildSlotComponent*                         ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Winch.Winch_C.UserConstructionScript
struct AWinch_C_UserConstructionScript_Params
{
};

// Function Winch.Winch_C.PickedUpFromWorld
struct AWinch_C_PickedUpFromWorld_Params
{
};

// Function Winch.Winch_C.DroppedInWorld
struct AWinch_C_DroppedInWorld_Params
{
...
struct AWinch_C_ReceiveBeginPlay_Params
{
};

// Function Winch.Winch_C.ReceiveEndPlay
struct AWinch_C_ReceiveEndPlay_Params
{
	TEnumAsByte<EEndPlayReason>                        EndPlayReason;                                            // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function Winch.Winch_C.ReceiveHit
struct AWinch_C_ReceiveHit_Params
{
...
struct AWinch_C_ExecuteUbergraph_Winch_Params
{
