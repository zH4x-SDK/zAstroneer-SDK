...
// BlueprintGeneratedClass TerrainBodiesSlot.TerrainBodiesSlot_C
// 0x0041 (0x0471 - 0x0430)
class ATerrainBodiesSlot_C : public AItemSlot
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TerrainBodiesSlot.TerrainBodiesSlot_C");
		return ptr;
	}
