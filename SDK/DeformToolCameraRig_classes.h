...
// BlueprintGeneratedClass DeformToolCameraRig.DeformToolCameraRig_C
// 0x0010 (0x0B28 - 0x0B18)
class ADeformToolCameraRig_C : public ACameraSpaceWalkingRig_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DeformToolCameraRig.DeformToolCameraRig_C");
		return ptr;
	}
