...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0568(0x0001) (Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0568(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0569(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x056C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x0570(0x0018) MISSED OFFSET
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                    // 0x0588(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                       // 0x058C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                    // 0x0590(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                       // 0x0594(0x0004) (ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x03B0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x03B4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x03B8(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x03D0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x03D8(0x0008) (ZeroConstructor, IsPlainOldData)
	EBeaconConnectionState                             ConnectionState;                                          // 0x03E0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x6F];                                      // 0x03E1(0x006F) MISSED OFFSET
...
{
public:
	int                                                ListenPort;                                               // 0x03D0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x03D4(0x0004) MISSED OFFSET
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x03D8(0x0010) (ZeroConstructor)
...
{
public:
	struct FString                                     BeaconTypeName;                                           // 0x03A8(0x0010) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x03B8(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FString                                     DestSessionId;                                            // 0x0510(0x0010) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x0520(0x0030)
	EClientRequestType                                 RequestType;                                              // 0x0550(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x0551(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x0552(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2D];                                      // 0x0553(0x002D) MISSED OFFSET
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x03D0(0x0008) (ZeroConstructor, IsPlainOldData)
