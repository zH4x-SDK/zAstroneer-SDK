...
// WidgetBlueprintGeneratedClass SymbolWidget.SymbolWidget_C
// 0x0008 (0x0210 - 0x0208)
class USymbolWidget_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SymbolWidget.SymbolWidget_C");
		return ptr;
	}
