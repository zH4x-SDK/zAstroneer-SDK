...
{
public:
	bool                                               bUseComplexAsSimpleCollision;                             // 0x06F0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bUseAsyncCooking;                                         // 0x06F1(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	TArray<struct FProcMeshSection>                    ProcMeshSections;                                         // 0x0700(0x0010) (ZeroConstructor)
