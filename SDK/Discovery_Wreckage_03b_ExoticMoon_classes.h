...
// BlueprintGeneratedClass Discovery_Wreckage_03b_ExoticMoon.Discovery_Wreckage_03b_ExoticMoon_C
// 0x0040 (0x03E8 - 0x03A8)
class ADiscovery_Wreckage_03b_ExoticMoon_C : public AActor
{
public:
	...
	class URaycastDistributionComponent*               WreckageStation03b;                                       // 0x03D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             Scene;                                                    // 0x03E0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Discovery_Wreckage_03b_ExoticMoon.Discovery_Wreckage_03b_ExoticMoon_C");
		return ptr;
	}
