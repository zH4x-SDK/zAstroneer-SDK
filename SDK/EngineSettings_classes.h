...
public:
	...
	struct FSoftObjectPath                             PostLobbyDefaultMap;                                      // 0x00A0(0x0018) (Edit, Config)
	struct FSoftObjectPath                             ServerDefaultMap;                                         // 0x00B8(0x0018) (Edit, Config)
	struct FSoftClassPath                              GlobalDefaultGameMode;                                    // 0x00D0(0x0018) (Edit, Config, NoClear)
	struct FSoftClassPath                              GlobalDefaultServerGameMode;                              // 0x00E8(0x0018) (Edit, Config)
	TArray<struct FGameModeName>                       GameModeMapPrefixes;                                      // 0x0100(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FGameModeName>                       GameModeClassAliases;                                     // 0x0110(0x0010) (Edit, ZeroConstructor, Config)
...
public:
	...
	struct FString                                     ProjectDisplayedTitleUnlocalized;                         // 0x0110(0x0010) (Edit, ZeroConstructor, Config)
