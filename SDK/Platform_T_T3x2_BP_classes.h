...
// BlueprintGeneratedClass Platform_T_T3x2_BP.Platform_T_T3x2_BP_C
// 0x0033 (0x0780 - 0x074D)
class APlatform_T_T3x2_BP_C : public APlatform_BASE_C
{
public:
	...
	class USceneComponent*                             Tether_Center_2;                                          // 0x0758(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             Tether_Center_1;                                          // 0x0760(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Platform_T_T3x2_BP.Platform_T_T3x2_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Platform_T_T3x2_BP(int EntryPoint);
};
