...
// BlueprintGeneratedClass Hazard_Popper_Collection_Combo_Ceiling.Hazard_Popper_Collection_Combo_Ceiling_C
// 0x0030 (0x03D8 - 0x03A8)
class AHazard_Popper_Collection_Combo_Ceiling_C : public AActor
{
public:
	...
	class URaycastDistributionComponent*               Popper01;                                                 // 0x03C0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Hazard_Popper_Collection_Combo_Ceiling.Hazard_Popper_Collection_Combo_Ceiling_C");
		return ptr;
	}
