...
// BlueprintGeneratedClass BP_Atmos_Mesh_Terran.BP_Atmos_Mesh_Terran_C
// 0x0020 (0x03C8 - 0x03A8)
class ABP_Atmos_Mesh_Terran_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Atmos_Mesh_Terran.BP_Atmos_Mesh_Terran_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Atmos_Mesh_Terran(int EntryPoint);
};
