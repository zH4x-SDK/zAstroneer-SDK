...
// WidgetBlueprintGeneratedClass ResearchModuleControlPanelPrimaryScreen.ResearchModuleControlPanelPrimaryScreen_C
// 0x0018 (0x0220 - 0x0208)
class UResearchModuleControlPanelPrimaryScreen_C : public UUserWidget
{
public:
	...
	class UTextBlock*                                  TitleText;                                                // 0x0218(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ResearchModuleControlPanelPrimaryScreen.ResearchModuleControlPanelPrimaryScreen_C");
		return ptr;
	}
