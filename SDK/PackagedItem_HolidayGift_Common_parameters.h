...
struct APackagedItem_HolidayGift_Common_C_HandleOnIndicatorVisibleChanged_Params
{
...
struct APackagedItem_HolidayGift_Common_C_HandleOnAssignPackageMaterial_Params
{
...
struct APackagedItem_HolidayGift_Common_C_HandleOnDeployReadyChanged_Params
{
...
struct APackagedItem_HolidayGift_Common_C_PickedUpFromWorld_Params
{
};

// Function PackagedItem_HolidayGift_Common.PackagedItem_HolidayGift_Common_C.ReceiveHit
struct APackagedItem_HolidayGift_Common_C_ReceiveHit_Params
{
...
struct APackagedItem_HolidayGift_Common_C_Authority_Unpack_Params
{
};

// Function PackagedItem_HolidayGift_Common.PackagedItem_HolidayGift_Common_C.DoUnpackAudioRPC
struct APackagedItem_HolidayGift_Common_C_DoUnpackAudioRPC_Params
{
};
...
struct APackagedItem_HolidayGift_Common_C_BndEvt__DeployableItemPackage_K2Node_ComponentBoundEvent_0_PackageIndicatorEvent__DelegateSignature_Params
{
	bool                                               IndicatorVisible;                                         // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct APackagedItem_HolidayGift_Common_C_BndEvt__DeployableItemPackage_K2Node_ComponentBoundEvent_1_PackageReadyEvent__DelegateSignature_Params
{
	bool                                               DeployReady;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct APackagedItem_HolidayGift_Common_C_BndEvt__DeployableItemPackage_K2Node_ComponentBoundEvent_2_AssignMaterialEvent__DelegateSignature_Params
{
	class UMaterialInterface*                          PackageMaterial;                                          // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct APackagedItem_HolidayGift_Common_C_ExecuteUbergraph_PackagedItem_HolidayGift_Common_Params
{
