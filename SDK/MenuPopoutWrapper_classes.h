...
// WidgetBlueprintGeneratedClass MenuPopoutWrapper.MenuPopoutWrapper_C
// 0x0028 (0x02A8 - 0x0280)
class UMenuPopoutWrapper_C : public UAstroGameMenuPopoutWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass MenuPopoutWrapper.MenuPopoutWrapper_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_MenuPopoutWrapper(int EntryPoint);
};
