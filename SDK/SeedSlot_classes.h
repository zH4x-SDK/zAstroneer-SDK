...
// BlueprintGeneratedClass SeedSlot.SeedSlot_C
// 0x0041 (0x0471 - 0x0430)
class ASeedSlot_C : public AItemSlot
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SeedSlot.SeedSlot_C");
		return ptr;
	}
