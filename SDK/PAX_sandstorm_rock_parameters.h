...
struct APAX_sandstorm_rock_C_UserConstructionScript_Params
{
};

// Function PAX_sandstorm_rock.PAX_sandstorm_rock_C.ReceiveTick
struct APAX_sandstorm_rock_C_ReceiveTick_Params
{
	float                                              DeltaSeconds;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function PAX_sandstorm_rock.PAX_sandstorm_rock_C.ReceiveHit
struct APAX_sandstorm_rock_C_ReceiveHit_Params
{
...
struct APAX_sandstorm_rock_C_ExecuteUbergraph_PAX_sandstorm_rock_Params
{
