...
// BlueprintGeneratedClass Discovery_WreckageArray_Barren.Discovery_WreckageArray_Barren_C
// 0x0048 (0x03F0 - 0x03A8)
class ADiscovery_WreckageArray_Barren_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Discovery_WreckageArray_Barren.Discovery_WreckageArray_Barren_C");
		return ptr;
	}
