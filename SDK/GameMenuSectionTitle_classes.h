...
// WidgetBlueprintGeneratedClass GameMenuSectionTitle.GameMenuSectionTitle_C
// 0x0030 (0x0490 - 0x0460)
class UGameMenuSectionTitle_C : public UAstroGameMenuFocusItemWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass GameMenuSectionTitle.GameMenuSectionTitle_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GameMenuSectionTitle(int EntryPoint);
};
