...
// BlueprintGeneratedClass DebrisBundle.DebrisBundle_C
// 0x0018 (0x06F8 - 0x06E0)
class ADebrisBundle_C : public ABundledItemBase_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DebrisBundle.DebrisBundle_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_DebrisBundle(int EntryPoint);
};
