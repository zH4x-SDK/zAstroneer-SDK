...
// WidgetBlueprintGeneratedClass CreditsWidgetPaul.CreditsWidgetPaul_C
// 0x0008 (0x0210 - 0x0208)
class UCreditsWidgetPaul_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass CreditsWidgetPaul.CreditsWidgetPaul_C");
		return ptr;
	}
