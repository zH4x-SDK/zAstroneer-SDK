...
// WidgetBlueprintGeneratedClass StartNewGamePopoutContents.StartNewGamePopoutContents_C
// 0x0028 (0x02A0 - 0x0278)
class UStartNewGamePopoutContents_C : public UAstroGameMenuPopoutWidgetContentsBase
{
public:
	...
	struct FScriptMulticastDelegate                    OnCustomizationFinalizationCanceled;                      // 0x0290(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass StartNewGamePopoutContents.StartNewGamePopoutContents_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_StartNewGamePopoutContents(int EntryPoint);
	void OnCustomizationFinalizationCanceled__DelegateSignature();
};
