...
// BlueprintGeneratedClass ThrusterSlot.ThrusterSlot_C
// 0x0028 (0x0458 - 0x0430)
class AThrusterSlot_C : public APowerSlot
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ThrusterSlot.ThrusterSlot_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_ThrusterSlot(int EntryPoint);
};
