...
// WidgetBlueprintGeneratedClass GameMenuTabBarButtonQuit.GameMenuTabBarButtonQuit_C
// 0x000E (0x0500 - 0x04F2)
class UGameMenuTabBarButtonQuit_C : public UGameMenuTabBarButton_Base_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass GameMenuTabBarButtonQuit.GameMenuTabBarButtonQuit_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GameMenuTabBarButtonQuit(int EntryPoint);
};
