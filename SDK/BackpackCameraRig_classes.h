...
// BlueprintGeneratedClass BackpackCameraRig.BackpackCameraRig_C
// 0x0010 (0x0B28 - 0x0B18)
class ABackpackCameraRig_C : public ACameraSpaceWalkingRig_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BackpackCameraRig.BackpackCameraRig_C");
		return ptr;
	}
