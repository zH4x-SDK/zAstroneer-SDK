...
// BlueprintGeneratedClass Hazard_Gasbag_v2_BASE.Hazard_Gasbag_v2_BASE_C
// 0x0024 (0x04A0 - 0x047C)
class AHazard_Gasbag_v2_BASE_C : public AHazard_Gasbag_v1_BASE_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Hazard_Gasbag_v2_BASE.Hazard_Gasbag_v2_BASE_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Hazard_Gasbag_v2_BASE(int EntryPoint);
};
