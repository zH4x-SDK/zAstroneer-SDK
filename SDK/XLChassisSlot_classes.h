...
// BlueprintGeneratedClass XLChassisSlot.XLChassisSlot_C
// 0x0080 (0x04B0 - 0x0430)
class AXLChassisSlot_C : public APowerSlot
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass XLChassisSlot.XLChassisSlot_C");
		return ptr;
	}
