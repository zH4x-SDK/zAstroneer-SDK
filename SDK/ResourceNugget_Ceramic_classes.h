...
// BlueprintGeneratedClass ResourceNugget_Ceramic.ResourceNugget_Ceramic_C
// 0x0011 (0x06E9 - 0x06D8)
class AResourceNugget_Ceramic_C : public AResourceBundle_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ResourceNugget_Ceramic.ResourceNugget_Ceramic_C");
		return ptr;
	}
	...
	void SetView();
	void ExecuteUbergraph_ResourceNugget_Ceramic(int EntryPoint);
};
