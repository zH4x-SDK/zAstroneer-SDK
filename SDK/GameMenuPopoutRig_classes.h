...
// BlueprintGeneratedClass GameMenuPopoutRig.GameMenuPopoutRig_C
// 0x0030 (0x0AE0 - 0x0AB0)
class AGameMenuPopoutRig_C : public ACameraRigActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GameMenuPopoutRig.GameMenuPopoutRig_C");
		return ptr;
	}
