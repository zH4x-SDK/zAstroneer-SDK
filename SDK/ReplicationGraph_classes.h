...
{
public:
	class UReplicationGraphNode_ActorList*             AlwaysRelevantNode;                                       // 0x02F0(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FConnectionAlwaysRelevantNodePair>   AlwaysRelevantForConnectionList;                          // 0x02F8(0x0010) (ZeroConstructor)
	TArray<class AActor*>                              ActorsWithoutNetConnection;                               // 0x0308(0x0010) (ZeroConstructor)
...
public:
	...
	unsigned char                                      UnknownData00[0x250];                                     // 0x0030(0x0250) MISSED OFFSET
	class AReplicationGraphDebugActor*                 DebugActor;                                               // 0x0280(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x0288(0x0018) MISSED OFFSET
	TArray<class UReplicationGraphNode*>               ConnectionGraphNodes;                                     // 0x02A0(0x0010) (ZeroConstructor)
	class UReplicationGraphNode_TearOff_ForConnection* TearOffNode;                                              // 0x02B0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x78];                                      // 0x02B8(0x0078) MISSED OFFSET
...
{
public:
	class UReplicationGraph*                           ReplicationGraph;                                         // 0x03A8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNetReplicationGraphConnection*              ConnectionManager;                                        // 0x03B0(0x0008) (ZeroConstructor, IsPlainOldData)
