...
{
public:
	class UMediaPlaneComponent*                        MediaPlane;                                               // 0x03A8(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	struct FMediaPlaneParameters                       Plane;                                                    // 0x06C0(0x0038) (Edit)
	unsigned char                                      UnknownData00[0x98];                                      // 0x06F8(0x0098) MISSED OFFSET
