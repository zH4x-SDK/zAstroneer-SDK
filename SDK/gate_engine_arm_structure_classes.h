...
// BlueprintGeneratedClass gate_engine_arm_structure.gate_engine_arm_structure_C
// 0x0028 (0x03D0 - 0x03A8)
class Agate_engine_arm_structure_C : public AActor
{
public:
	...
	class UStaticMeshComponent*                        gate_engine_arm_center;                                   // 0x03C0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             DefaultSceneRoot;                                         // 0x03C8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass gate_engine_arm_structure.gate_engine_arm_structure_C");
		return ptr;
	}
