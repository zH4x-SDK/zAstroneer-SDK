...
// BlueprintGeneratedClass Decorator_MineralFlecks.Decorator_MineralFlecks_C
// 0x0028 (0x03D0 - 0x03A8)
class ADecorator_MineralFlecks_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Decorator_MineralFlecks.Decorator_MineralFlecks_C");
		return ptr;
	}
