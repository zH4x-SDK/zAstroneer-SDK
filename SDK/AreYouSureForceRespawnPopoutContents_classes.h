...
// WidgetBlueprintGeneratedClass AreYouSureForceRespawnPopoutContents.AreYouSureForceRespawnPopoutContents_C
// 0x0028 (0x02A0 - 0x0278)
class UAreYouSureForceRespawnPopoutContents_C : public UAstroGameMenuPopoutWidgetContentsBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass AreYouSureForceRespawnPopoutContents.AreYouSureForceRespawnPopoutContents_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AreYouSureForceRespawnPopoutContents(int EntryPoint);
