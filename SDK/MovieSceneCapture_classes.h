...
{
public:
	struct FColor                                      ColorKey;                                                 // 0x0028(0x0004) (Edit, Config, IsPlainOldData)
...
public:
	...
	struct FColor                                      ColorKey;                                                 // 0x0034(0x0004) (Edit, Config, IsPlainOldData)
...
public:
	...
	struct FColor                                      ColorKey;                                                 // 0x0038(0x0004) (Edit, Config, IsPlainOldData)
