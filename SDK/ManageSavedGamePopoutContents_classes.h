...
// WidgetBlueprintGeneratedClass ManageSavedGamePopoutContents.ManageSavedGamePopoutContents_C
// 0x00A1 (0x0319 - 0x0278)
class UManageSavedGamePopoutContents_C : public UAstroGameMenuPopoutWidgetContentsBase
{
public:
	...
	bool                                               SaveFileTooLargeToSave;                                   // 0x0318(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ManageSavedGamePopoutContents.ManageSavedGamePopoutContents_C");
		return ptr;
	}
	...
	void CustomEvent_1(ESaveGameOperationResult saveOperationResult);
	void DoSaveFileLoad();
	...
	void ExecuteUbergraph_ManageSavedGamePopoutContents(int EntryPoint);
