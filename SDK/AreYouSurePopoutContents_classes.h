...
// WidgetBlueprintGeneratedClass AreYouSurePopoutContents.AreYouSurePopoutContents_C
// 0x0028 (0x02A0 - 0x0278)
class UAreYouSurePopoutContents_C : public UAstroGameMenuPopoutWidgetContentsBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass AreYouSurePopoutContents.AreYouSurePopoutContents_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AreYouSurePopoutContents(int EntryPoint);
