...
// BlueprintGeneratedClass Discovery_Wreckage_04a.Discovery_Wreckage_04a_C
// 0x0040 (0x03E8 - 0x03A8)
class ADiscovery_Wreckage_04a_C : public AActor
{
public:
	...
	class URaycastDistributionComponent*               WreckageStation04a;                                       // 0x03D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             Scene;                                                    // 0x03E0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Discovery_Wreckage_04a.Discovery_Wreckage_04a_C");
		return ptr;
	}
