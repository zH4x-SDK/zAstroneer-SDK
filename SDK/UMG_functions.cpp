...
// Function UMG.Widget.ComputeDesiredSize
// (Final, Native, Public, HasDefaults, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// float                          layoutScaleMultiplier          (Parm, ZeroConstructor, IsPlainOldData)
// struct FVector2D               ReturnValue                    (Parm, OutParm, ReturnParm, IsPlainOldData)

struct FVector2D UWidget::ComputeDesiredSize(float layoutScaleMultiplier)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.Widget.ComputeDesiredSize");

	UWidget_ComputeDesiredSize_Params params;
	params.layoutScaleMultiplier = layoutScaleMultiplier;
...
// Function UMG.BorderSlot.GetPadding
// (Final, Native, Public, BlueprintCallable, BlueprintPure)
// Parameters:
// struct FMargin                 ReturnValue                    (Parm, OutParm, ReturnParm)

struct FMargin UBorderSlot::GetPadding()
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.BorderSlot.GetPadding");

	UBorderSlot_GetPadding_Params params;
...
// Function UMG.EditableText.SetKeyboardType
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// TEnumAsByte<EVirtualKeyboardType> NewKeyboardType                (Parm, ZeroConstructor, IsPlainOldData)

void UEditableText::SetKeyboardType(TEnumAsByte<EVirtualKeyboardType> NewKeyboardType)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.EditableText.SetKeyboardType");

	UEditableText_SetKeyboardType_Params params;
	params.NewKeyboardType = NewKeyboardType;
...
void UEditableTextBox::SetKeyboardType(TEnumAsByte<EVirtualKeyboardType> NewKeyboardType)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.EditableTextBox.SetKeyboardType");

	UEditableTextBox_SetKeyboardType_Params params;
	params.NewKeyboardType = NewKeyboardType;
...
// Function UMG.EditableTextBox.SetForceUpperCase
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                           InbForceUpperCase              (Parm, ZeroConstructor, IsPlainOldData)

void UEditableTextBox::SetForceUpperCase(bool InbForceUpperCase)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.EditableTextBox.SetForceUpperCase");

	UEditableTextBox_SetForceUpperCase_Params params;
	params.InbForceUpperCase = InbForceUpperCase;
...
// Function UMG.Slider.ForwardOnMouseButtonDownToSWidget
// (Final, Native, Public, HasOutParms, BlueprintCallable)
// Parameters:
...
struct FEventReply USlider::ForwardOnMouseButtonDownToSWidget(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.Slider.ForwardOnMouseButtonDownToSWidget");

	USlider_ForwardOnMouseButtonDownToSWidget_Params params;
	params.MyGeometry = MyGeometry;
	params.MouseEvent = MouseEvent;
