...
// BlueprintGeneratedClass WreckageStation03a_GLOBAL.WreckageStation03a_GLOBAL_C
// 0x0058 (0x0400 - 0x03A8)
class AWreckageStation03a_GLOBAL_C : public AActor
{
public:
	...
	class UChildSlotComponent*                         ChildSlot;                                                // 0x03B0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UChildSlotComponent*                         ChildSlot4;                                               // 0x03B8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class USceneComponent*                             Scene1;                                                   // 0x03D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UWorldGravity*                               WorldGravity;                                             // 0x03F0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        StaticMesh;                                               // 0x03F8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass WreckageStation03a_GLOBAL.WreckageStation03a_GLOBAL_C");
		return ptr;
	}
