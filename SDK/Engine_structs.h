...
// Enum Engine.ESaveGameOperationResult
enum class ESaveGameOperationResult : uint8_t
{
	ESaveGameOperationResult__Success = 0,
	ESaveGameOperationResult__ErrorNotEnoughSpace = 1,
	ESaveGameOperationResult__ErrorUnspecified = 2,
	ESaveGameOperationResult__ESaveGameOperationResult_MAX = 3
};
...
// Enum Engine.EAutoDormancySource
enum class EAutoDormancySource : uint8_t
{
	EAutoDormancySource__ADS_None  = 0,
	EAutoDormancySource__ADS_Physics = 1,
	EAutoDormancySource__ADS_Slot  = 2,
	EAutoDormancySource__ADS_PhysicsAndSlotMask = 3,
	EAutoDormancySource__ADS_MAX   = 4
};
...
// Enum Engine.ESaveGameFileType
enum class ESaveGameFileType : uint8_t
{
	ESaveGameFileType__Configuration = 0,
	ESaveGameFileType__SaveGame    = 1,
	ESaveGameFileType__Legacy      = 2,
	ESaveGameFileType__ESaveGameFileType_MAX = 3
};
...
struct FRepMovement
{
	...
	unsigned char                                      bHasAttachParent : 1;                                     // 0x0030(0x0001) (Transient)
...
struct FRepAttachment
{
	...
	unsigned char                                      bIsWelded : 1;                                            // 0x0040(0x0001)
	unsigned char                                      bHasAttachParent : 1;                                     // 0x0040(0x0001)
...
struct FBodyInstance
{
	...
	unsigned char                                      UnknownData05 : 1;                                        // 0x007B(0x0001)
	...
	unsigned char                                      UnknownData06[0x8];                                       // 0x0080(0x0008) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0x13];                                      // 0x00BD(0x0013) MISSED OFFSET
	...
	unsigned char                                      UnknownData08[0x3C];                                      // 0x00FC(0x003C) MISSED OFFSET
	uint64_t                                           RigidActorSyncId;                                         // 0x0138(0x0008) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           RigidActorAsyncId;                                        // 0x0140(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                VelocitySolverIterationCount;                             // 0x0148(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0xF4];                                      // 0x014C(0x00F4) MISSED OFFSET
};
...
struct FInstancedStaticMeshInstanceData
{
	...
	float                                              Index;                                                    // 0x0040(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
// ScriptStruct Engine.NetUnstableActorReference
// 0x0010
struct FNetUnstableActorReference
{
	uint32_t                                           ActorGUID;                                                // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	class AActor*                                      Actor;                                                    // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};
...
struct FWorldContext
{
	...
	struct FURL                                        LastURL;                                                  // 0x00F8(0x0070)
	struct FURL                                        LastRemoteURL;                                            // 0x0168(0x0070)
	class UPendingNetGame*                             PendingNetGame;                                           // 0x01D8(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FFullyLoadedPackagesInfo>            PackagesToFullyLoad;                                      // 0x01E0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x10];                                      // 0x01F0(0x0010) MISSED OFFSET
	TArray<class ULevel*>                              LoadedLevelsForPendingMapChange;                          // 0x0200(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x18];                                      // 0x0210(0x0018) MISSED OFFSET
	TArray<class UObjectReferencer*>                   ObjectReferencers;                                        // 0x0228(0x0010) (ZeroConstructor)
	TArray<struct FLevelStreamingStatus>               PendingLevelStreamingStatusUpdates;                       // 0x0238(0x0010) (ZeroConstructor)
	class UGameViewportClient*                         GameViewport;                                             // 0x0248(0x0008) (ZeroConstructor, IsPlainOldData)
...
struct FAnimUpdateRateParameters
{
	...
	unsigned char                                      UpdateRate;                                               // 0x0004(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      EvaluationRate;                                           // 0x0005(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0006(0x0002) MISSED OFFSET
	unsigned char                                      bInterpolateSkippedFrames : 1;                            // 0x0008(0x0001)
	unsigned char                                      bSkipUpdate : 1;                                          // 0x0008(0x0001)
	unsigned char                                      bSkipEvaluation : 1;                                      // 0x0008(0x0001)
	...
	unsigned char                                      UnknownData03[0x4];                                       // 0x0014(0x0004) MISSED OFFSET
	int                                                BaseNonRenderedUpdateRate;                                // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	TMap<int, int>                                     LODToFrameSkipMap;                                        // 0x0020(0x0050) (ZeroConstructor)
	int                                                MaxEvalRateForInterpolation;                              // 0x0070(0x0004) (ZeroConstructor, IsPlainOldData)
	EUpdateRateShiftBucket                             ShiftBucket;                                              // 0x0074(0x0001) (ZeroConstructor, IsPlainOldData)
