...
// BlueprintGeneratedClass BP_Atmos_Mesh_TerranMoon.BP_Atmos_Mesh_TerranMoon_C
// 0x0020 (0x03C8 - 0x03A8)
class ABP_Atmos_Mesh_TerranMoon_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Atmos_Mesh_TerranMoon.BP_Atmos_Mesh_TerranMoon_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Atmos_Mesh_TerranMoon(int EntryPoint);
};
